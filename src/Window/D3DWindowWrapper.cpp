...
//}
//
//int D3DWindowWrapper::D3DModsToInputManagerMods(int glfwMods)
//{
//	int inputMods = 0;
//
//	if (glfwMods & VK_SHIFT) inputMods |= (int)InputManager::Mod::SHIFT;
//	if (glfwMods & VK_MENU) inputMods |= (int)InputManager::Mod::ALT;
//	if (glfwMods & VK_CONTROL) inputMods |= (int)InputManager::Mod::CONTROL;
//	if ((glfwMods & VK_LWIN) || (glfwMods & VK_RWIN)) inputMods |= (int)InputManager::Mod::SUPER;
//
//	return inputMods;
//}
//
...
//	switch (button)
//	{
//	case MK_LBUTTON: inputMouseButton = InputManager::MouseButton::MOUSE_BUTTON_1; break;
//	case MK_MBUTTON: inputMouseButton = InputManager::MouseButton::MOUSE_BUTTON_2; break;
//	case MK_RBUTTON: inputMouseButton = InputManager::MouseButton::MOUSE_BUTTON_3; break;
//	case MK_XBUTTON1: inputMouseButton = InputManager::MouseButton::MOUSE_BUTTON_4; break;
//	case MK_XBUTTON2: inputMouseButton = InputManager::MouseButton::MOUSE_BUTTON_5; break;
...
void D3DWindowWrapper::RegisterWindow(const std::string& title, glm::vec2i size, const GameContext& gameContext)
{
	...
	SetWindowLongPtr(m_Window, GWLP_USERDATA, reinterpret_cast<LONG_PTR>(gameContext.mainApp));
...
LRESULT D3DWindowWrapper::WndProcedure(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	TechDemo* mainApp = (TechDemo*)GetWindowLongPtr(hWnd, GWL_USERDATA);
