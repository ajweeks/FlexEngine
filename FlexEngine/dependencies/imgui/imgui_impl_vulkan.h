...
IMGUI_IMPL_API void    ImGui_ImplVulkan_AddTexture(VkSampler sampler, VkImageView image_view, VkImageLayout image_layout, VkDescriptorSet* out_descriptor_set);
