...
namespace flex
{
	...
	void DebugCamera::LoadAzertyKeybindings()
	{
	...
	real DebugCamera::GetYaw() const
	{
		return m_Yaw;
	}

	void DebugCamera::SetYaw(real yawRad)
	{
		m_Yaw = yawRad;
	}

	real DebugCamera::GetPitch() const
	{
		return m_Pitch;
	}

	void DebugCamera::SetPitch(real pitchRad)
	{
		m_Pitch = pitchRad;
	}
} // namespace flex
