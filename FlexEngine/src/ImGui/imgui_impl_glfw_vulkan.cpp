...
static void ImGui_ImplGlfwVulkan_UpdateBuffers()
{
	VkResult err;
...
bool    ImGui_ImplGlfwVulkan_Init(GLFWwindow* window, ImGui_ImplGlfwVulkan_Init_Data *init_data)
{
	...
	//ImGui_ImplGlfwVulkan_UpdateBuffers();
...
{
	// Prevent future Vulkan instances from having a negative DeltaTime
	g_Time = 0.0;
...
void ImGui_ImplGlfwVulkan_Render()
{
	ImGui::Render();
	ImGui_ImplGlfwVulkan_UpdateBuffers();
}

void ImGui_ImplGlfwVulkan_DrawFrame(VkCommandBuffer command_buffer)
{
