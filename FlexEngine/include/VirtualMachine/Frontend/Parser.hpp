...
namespace flex
{
	...
	namespace AST
	{
		...
		{
			ForStatement(const Span& span, Statement* setup, Statement* condition, Statement* update, Statement* body) :
		...
		struct AST
		{
			...
			void Generate(const char* sourceText);
			void Destroy();
