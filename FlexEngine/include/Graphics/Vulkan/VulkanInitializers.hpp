...
// Initializers for Vulkan structures - modified version of Sascha Willems' Vulkan example repo:
...
namespace flex
{
	namespace vks
	{
			...
			const std::vector<VkPipelineColorBlendAttachmentState>& attachments)
		{
			VkPipelineColorBlendStateCreateInfo pipelineColorBlendStateCreateInfo{};
			pipelineColorBlendStateCreateInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO;
			pipelineColorBlendStateCreateInfo.attachmentCount = static_cast<u32>(attachments.size());
		...
		inline VkPipelineDepthStencilStateCreateInfo pipelineDepthStencilStateCreateInfo(
			...
			VkBool32 stencilCompareEnable = VK_FALSE)
		{
			...
			pipelineDepthStencilStateCreateInfo.stencilTestEnable = stencilCompareEnable;
		...
		inline VkRect2D scissor(u32 x, u32 y, u32 w, u32 h)
		{
			VkRect2D rect{};
			rect.offset.x = x;
			rect.offset.y = y;
		...
		// Ray tracing related
		inline VkPhysicalDeviceRayTracingPipelineFeaturesKHR rayTracingPipelineFeaturesKHR()
		{
